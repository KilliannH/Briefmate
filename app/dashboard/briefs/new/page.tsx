  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Nouveau brief</h1>
        <p className="text-gray-600 mt-1">Créez un nouveau brief pour organiser votre projet</p>
      </div>

      <form action={createBrief} className="bg-white rounded-lg shadow p-6 space-y-6">
        {/* Titre */}
        <div>

import { getTemplate, updateTemplate } from "@/app/actions/templates"
...
export default async function EditTemplatePage({ params }: { params: { id: string } }) {
  ...
  const initialTasks = tasksArray ? tasksArray.map(t => t.title) : []
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">Modifiez les informations de votre template</p>
      </div>
      ...
      <form action={handleUpdate} className="bg-white rounded-lg shadow p-6 space-y-6">
        ...
        {/* Tâches prédéfinies */}
        <TemplateTasksForm initialTasks={initialTasks} />
